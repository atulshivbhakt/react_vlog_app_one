     ...
     <div className="bollywoodContainer">
        ...
        <div className="right">
          ...
          {filtered
            ...
            <img src="https://img.freepik.com/premium-vector/creative-fitness-gym-training-instagram-post-social-media-web-banner-template-premium-vector_506195-103.jpg" width="500px"></img>
            </div>
        </div>
      </div>
